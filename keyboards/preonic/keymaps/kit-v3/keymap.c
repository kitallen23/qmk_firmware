...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_GRV,  KC_LEFT, KC_DOWN, KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_ENT,  _______, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS,  \

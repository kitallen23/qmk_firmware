...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_PSCR, KC_HOME, KC_UP,   KC_END,  KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_DQUO,
    _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_LBRC, KC_RBRC, KC_BSLS, _______, _______, _______, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______, KC_MUTE,
